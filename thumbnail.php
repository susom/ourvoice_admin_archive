...
//Alternatively, we might want to have thumbnails that are all the same size, regardless of the original proportions. 
//<img src="thumbnail.php?file=img.jpg&width=50&height=50" />
